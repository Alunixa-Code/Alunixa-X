...
use alunixa_x_core::dream_skin_library::{
...
use alunixa_x_core::settings::{BackendSettings, DreamSkinThemeConfig};
...
fn save_rejects_css_injection_in_color_fields() {
    ...
    draft
        .config
        .colors
        .get_or_insert_with(alunixa_x_core::settings::DreamSkinColors::default)
