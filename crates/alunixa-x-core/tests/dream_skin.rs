use alunixa_x_core::dream_skin::{
    import_dream_skin_image, is_managed_dream_skin_image, sync_dream_skin_base_theme_in_home,
};
use alunixa_x_core::settings::{BackendSettings, DreamSkinThemeConfig, SettingsStore};
...
fn backend_settings_defaults_to_upstream_platform_theme_config() {
    ...
    assert_eq!(theme.id, "dream-skin-default");
    ...
    assert_eq!(theme.extra_fields["art"]["safeArea"], "auto");
