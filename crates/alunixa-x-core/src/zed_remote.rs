...
pub enum ZedRemoteError {
    ...
    #[error("Cannot read Alunixa X Zed remote project registry")]
    RegistryRead(#[source] std::io::Error),
    #[error("Cannot parse Alunixa X Zed remote project registry")]
    RegistryParse(#[source] serde_json::Error),
    #[error("Cannot write Alunixa X Zed remote project registry")]
