...
Section "Install"
  ...
  CreateShortcut "$SMPROGRAMS\Alunixa X\AX - Alunixa X.lnk" "$INSTDIR\alunixa-x-manager.exe" "" "$INSTDIR\alunixa-x-manager.exe"
  CreateShortcut "$SMPROGRAMS\Alunixa X\AX Launch - Alunixa X.lnk" "$INSTDIR\alunixa-x.exe" "" "$INSTDIR\alunixa-x.exe"
...
Section "Uninstall"
  ...
  Delete "$SMPROGRAMS\Alunixa X\AX - Alunixa X.lnk"
  Delete "$SMPROGRAMS\Alunixa X\AX Launch - Alunixa X.lnk"
