...
export const EN_PLAIN: Record<string, string> = {
  ...
  "导出完整 Codex++ 配置": "Export complete Codex++ configuration",
  "Codex++ 配置备份": "Codex++ configuration backup",
  "配置导出": "Configuration export",
  "导入完整 Codex++ 配置": "Import complete Codex++ configuration",
  ...
  "用于迁移或恢复 Codex++ 的完整配置": "A complete Codex++ configuration for migration or recovery",
