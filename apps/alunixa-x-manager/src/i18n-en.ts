...
export const EN_PLAIN: Record<string, string> = {
  ...
  "Web 场景 · 在 Codex 中隔离运行": "Web scene · sandboxed inside Codex",
  ...
  "暂停视频": "Pause video",
  "原生 Scene 需要 Windows 和已安装的 Wallpaper Engine；仅捕获独立渲染窗口，不修改桌面壁纸。": "Native scenes require Windows and Wallpaper Engine. Only a dedicated render window is captured; your desktop wallpaper is not changed.",
