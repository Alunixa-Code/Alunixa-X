...
export const EN_PLAIN: Record<string, string> = {
  ...
  "开机时启动 Alunixa X 管理器": "Start Alunixa X Manager at login",
  ...
  "编辑扩展项": "Edit entry",
  "缺失": "Missing",
  "缺少 Alunixa X 静默启动快捷方式时可在安装维护页修复。": "When the Alunixa X silent launch shortcut is missing, repair it on the Install & Maintenance page.",
