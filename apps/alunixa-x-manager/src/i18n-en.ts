// English translations for the Alunixa X manager UI, keyed by the original
...
export const EN_PLAIN: Record<string, string> = {
  "选择 Wallpaper Engine 壁纸目录": "Choose a Wallpaper Engine project folder",
  "上传壁纸媒体": "Import wallpaper media",
  "图片与视频": "Images and videos",
  "选择 Wallpaper Engine 程序": "Choose Wallpaper Engine executable",
  "动态壁纸": "Live wallpapers",
  "上传视频或动图，也可以选择 Wallpaper Engine 的单个项目目录。": "Import a video or animated image, or select a single Wallpaper Engine project folder.",
  "启用壁纸": "Enable wallpaper",
  "尚未选择壁纸": "No wallpaper selected",
  "预览失败，请检查文件或视频编码。": "Preview failed. Check the file or video codec.",
  "原生场景 · 由 Wallpaper Engine 渲染": "Native scene · rendered by Wallpaper Engine",
  "Web 场景 · 由 Wallpaper Engine 渲染": "Web scene · rendered by Wallpaper Engine",
  "选择项目目录": "Choose project folder",
  "壁纸文件或项目路径": "Wallpaper file or project path",
  "透明度": "Opacity",
  "静音播放": "Mute playback",
  "继续播放": "Resume playback",
  "暂停视频": "Pause video",
  "Scene / Web 项目需要 Windows 和已安装的 Wallpaper Engine；仅捕获独立渲染窗口，不修改桌面壁纸。": "Scene / Web projects require Windows and Wallpaper Engine. Only a dedicated render window is captured; your desktop wallpaper is not changed.",
  ...
  "Web 项目在 Wallpaper Engine 中运行，Codex 只接收窗口画面；网络和宿主功能由 Wallpaper Engine 管理。": "Web projects run in Wallpaper Engine; Codex receives only the window video. Wallpaper Engine manages network access and host features.",
  ...
  "处理中…": "Working…",
  "配置已备份并修复，请重新打开报错的任务。": "Configuration backed up and repaired. Reopen the affected task.",
  "未发现无效的 guardianv2 配置，无需修改。": "No invalid guardianv2 configuration found; nothing changed.",
  "修复对话配置": "Repair task configuration",
  "生图模型": "Image models",
  ...
  "放弃编辑": "Discard edit",
  "继续编辑": "Keep editing",
  "配置 MCP 生图 API，拖拽排列并选择默认模型": "Configure image-generation APIs for MCP and drag to choose the default model",
  "读取生图模型失败，请刷新后重试；原配置未被替换。": "Could not load image models. Refresh to retry; the saved configuration has not been replaced.",
  "已保存，下一次 MCP 生图调用使用新配置。": "Saved. The next MCP image request will use this configuration.",
  "保存失败，请重试。": "Could not save. Please retry.",
  "请输入有效的 Model 名称。": "Enter a valid model name.",
  "请输入 HTTP/HTTPS API 地址，不要包含凭据、查询参数或片段。": "Enter an HTTP/HTTPS API URL without credentials, query parameters, or fragments.",
  "请输入 API Key；已有配置留空可保留原 Key。": "Enter an API key. Leave it blank to keep an existing key.",
  "MCP 生图配置": "MCP image configuration",
  "拖动手柄上下排序，最上方为默认模型；排序会自动保存。": "Drag the handles to reorder. The first model is the default; order changes save automatically.",
  "添加生图模型": "Add image model",
  "正在保存生图模型…": "Saving image models…",
  "生图模型编辑": "Image model editor",
  "编辑生图模型": "Edit image model",
  "取消编辑": "Cancel edit",
  "名称（可选）": "Name (optional)",
  "例如：常用生图": "For example: Everyday images",
  "API 地址": "API URL",
  "使用兼容 OpenAI Images 的 API 基础地址，支持生成与图片编辑。": "Use an OpenAI Images-compatible API base URL for generation and image editing.",
  "已保存，留空保留原 Key": "Saved; leave blank to keep the key",
  "输入 API Key": "Enter API key",
  "Key 仅保存在本机配置中，不会显示在模型列表或发送给对话模型。": "Keys are stored in local configuration, never shown in this list or sent to the conversation model.",
  "保存生图模型": "Save image model",
  "正在读取生图模型…": "Loading image models…",
  "还没有独立的生图模型": "No image models configured",
  "添加 API、Key 和 Model，第一项会自动成为默认模型。": "Add an API URL, key, and model. The first entry becomes the default.",
  "按空格开始排序，使用上下箭头移动，再按空格保存；按 Escape 取消。": "Press Space to pick up, use the arrow keys to move, then press Space to save or Escape to cancel.",
  "生图模型优先级": "Image model priority",
  "未配置生图模型时，继续使用当前对话供应商和原默认生图模型；不会自动切换或重试其他生图配置。": "With no image models configured, the current conversation provider and original default image model are used. Requests never automatically switch or retry another image configuration.",
  "默认": "Default",
  "上移": "Move up",
  "下移": "Move down",
  ...
  "缓存": "Cached",
  "其他模型": "Other models",
  "Agent 启动入口": "Agent launch entrypoint",
  "Alunixa X 主入口": "Alunixa X main entrypoint",
  "缺少 Alunixa X Launch 快捷方式时可在安装维护页修复。": "Repair a missing Alunixa X Launch shortcut from Install & Maintenance.",
  "缺少 Alunixa X 主入口快捷方式时可在安装维护页修复。": "Repair a missing Alunixa X main shortcut from Install & Maintenance.",
  "Agent 能力": "Agent capabilities",
  "等待选择模型": "Waiting for model selection",
  "默认供应商": "Default provider",
  "工具": "Tools",
  "增强已接管": "Enhancements attached",
  "基础模式": "Base mode",
  "等待检测": "Waiting for detection",
  "运行": "Runtime",
  "把模型、工具和 Codex 接入同一条 Agent 运行轨道":
    "Connect models, tools, and Codex on one agent rail",
  "从供应商路由到本地工具，再到桌面 Agent；所有关键状态都在这里连续呈现。":
  ...
  "待机": "Standby",
  "系统检查": "System checks",
  "只显示需要马上关注的桌面运行条件": "Only desktop runtime conditions that need immediate attention",
  "重建入口": "Rebuild entrypoints",
  "最近运行": "Latest runtime",
  "Helper 与桌面运行时已建立连接。": "The helper is connected to the desktop runtime.",
  "启动后将在这里显示 CDP、Helper 和注入状态。": "CDP, helper, and injection status will appear here after launch.",
  "日志与诊断": "Logs and diagnostics",
  "面向桌面 AI Agent 的模型、工具、连接与运行控制系统":
    "A model, tool, connection, and runtime control system for desktop AI agents",
  "模型、工具、Codex 与桌面运行时的统一控制面":
    "A unified control surface for models, tools, Codex, and the desktop runtime",
  "管理 Codex 集成、共享终端、会话与自动化能力":
    "Manage Codex integration, shared terminal, tasks, and automation",
  ...
  "仅在当前供应商启用时生效；精确匹配模型名并使用目标供应商的 URL 与 Key。目标必须是 Responses API，且需要从 Alunixa X 启动。":
    "Applies only while this provider is active. It exactly matches the model name and uses the target provider's URL and key. The target must use the Responses API, and Codex must be launched through Alunixa X.",
  ...
  "主题应用后将在下次通过 Alunixa X 启动时生效":
    "Applied themes take effect the next time Codex starts through Alunixa X",
  ...
  "已扫码，请在微信中确认": "Scanned. Confirm in WeChat",
  "使用微信扫描二维码": "Scan the QR code with WeChat",
  "确认后登录信息会直接保存，不会在页面显示连接 token。":
    "After confirmation, sign-in data is saved directly and the connection token is never displayed.",
  "会话目标": "Task target",
  "可直接输入目录，或搜索已有会话的工作目录":
    "Enter a directory directly or search working directories from existing tasks",
  "工作目录": "Working directory",
  "输入目录或选择已有会话": "Enter a directory or choose an existing task",
  "选择文件夹": "Choose folder",
  "模型": "Model",
  "留空时使用 Codex 当前默认模型": "Leave blank to use the current default Codex model",
  "沙箱权限": "Sandbox access",
  "只读": "Read only",
  "工作区可写": "Workspace write",
  "完全访问": "Full access",
  "允许联系人": "Allowed contacts",
  "逗号分隔联系人 ID；留空允许所有联系人":
    "Comma-separated contact IDs; leave blank to allow all contacts",
  "连接设置": "Connection settings",
  "默认连接固定微信服务，并复用本机 Codex app-server":
    "Uses the fixed WeChat service and the local Codex app-server by default",
  "留空使用 PATH 中的 codex": "Leave blank to use codex from PATH",
  "查找桌面版内置 CLI": "Find bundled desktop CLI",
  "仅允许微信官方 HTTPS 服务地址。": "Only official WeChat HTTPS service addresses are allowed.",
  "路由标签": "Route tag",
  "通常留空": "Usually left blank",
  "未启动": "Stopped",
  "启动中": "Starting",
  "正在重连": "Reconnecting",
  "正在停止": "Stopping",
  "通过个人微信连接本机 Codex 会话": "Connect local Codex tasks through personal WeChat",
  ...
  "开机时启动 Alunixa X": "Start Alunixa X at login",
  ...
  "自动压缩 Token 阈值": "Auto-compaction token threshold",
  "达到该 Token 数时自动压缩；阈值必须是正整数且不能超过上下文窗口。": "Compact automatically at this token count. The threshold must be a positive integer no larger than the context window.",
  ...
  "Alunixa X 导入": "Alunixa X import",
  "导出完整 Alunixa X 配置": "Export complete Alunixa X configuration",
  "Alunixa X 配置备份": "Alunixa X configuration backup",
  "配置导出": "Configuration export",
  "导入完整 Alunixa X 配置": "Import complete Alunixa X configuration",
  "配置导入": "Configuration import",
  "Alunixa X 版本": "Alunixa X version",
  ...
  "Watcher 用于保持 Alunixa X 接管状态": "The watcher keeps Alunixa X in control",
  ...
  "保存到 Alunixa X state，不改写 Zed settings。": "Saved to Alunixa X state, does not modify Zed settings.",
  ...
  "关闭后启动器不会应用供应商配置；启用后将在下次通过 Alunixa X 启动时完整写入当前供应商、模型目录和默认模型。":
    "When disabled, the launcher does not apply provider settings. When enabled, the next Alunixa X startup writes the active provider, model catalog, and default model in full.",
  ...
  "切换语言会重新加载管理器，未保存的编辑将丢失。已保存的配置和 Codex 语言不受影响。": "Changing language reloads the manager and discards unsaved edits. Saved settings and the Codex language are not affected.",
  "切换语言": "Change language",
  "无法保存语言设置，请检查本地存储后重试。": "Could not save the language preference. Check local storage and try again.",
  "显示窗口": "Show window",
  "退出": "Quit",
  ...
  "卸载时移除 Alunixa X 托管数据": "Remove Alunixa X managed data on uninstall",
  ...
  "阻止官方 Codex 自动下载和安装更新，不影响 Alunixa X 自身的 GitHub Release 更新。需重启 Codex 才能完整生效。":
    "Prevents the official Codex app from automatically downloading and installing updates without affecting Alunixa X GitHub Release updates. Requires restarting Codex.",
  ...
  "在 Codex 页面显示可拖动的后续建议浮层；建议由单独配置的 Stepwise API 生成。启停后需重启 Alunixa X 生效。":
    "Shows a draggable follow-up suggestion overlay in the Codex page. Suggestions are generated by a separate Stepwise API. Restart Alunixa X after changing this setting.",
  ...
  "完整配置备份": "Complete configuration backup",
  "用于迁移或恢复 Alunixa X 的完整配置": "A complete Alunixa X configuration for migration or recovery",
  "导出文件包含供应商 API Key、Codex 登录信息和用户脚本，请仅保存在可信位置。":
    "The export contains provider API keys, Codex sign-in data, and user scripts. Store it only in a trusted location.",
  "导出完整配置": "Export complete configuration",
  "导入完整配置": "Import complete configuration",
  "官方": "Official",
  ...
  "导入 Alunixa X 供应商": "Import Alunixa X provider",
  ...
  "开启": "On",
  "开启后，通过 Alunixa X 启动 Codex 前自动整理一次旧对话的归属标记。":
    "When on, tidies up ownership tags of old conversations once before launching Codex through Alunixa X.",
  ...
  "把 Alunixa X 菜单插入 Codex 顶部原生菜单栏。": "Insert the Alunixa X menu into Codex's top native menu bar.",
  ...
  "使用 Alunixa X 内置快照补齐远端插件，API 模式也可显示和安装 Product Design 插件。":
    "Use the embedded Alunixa X snapshot to add remote plugins, so API mode can also show and install the Product Design plugin.",
  ...
  "未发现本地缓存；点击按钮会从 Alunixa X 内置快照释放并注册，无需官方账号预缓存。":
    "Local cache not found. Click the button to extract and register the embedded Alunixa X snapshot; no official-account pre-cache is required.",
  "未知": "Unknown",
  "未知作者": "Unknown author",
  "未知来源": "Unknown source",
  ...
  "检测到来自网页的供应商配置导入请求，确认后会写入本机 Alunixa X。":
    "A provider config import request from the web was detected; confirming writes it to this machine's Alunixa X app.",
  "概览": "Overview",
  ...
  "正常": "OK",
  "此上游会通过本地 127.0.0.1:57321 转成 Responses API，需要从 Alunixa X 启动 Codex。":
    "This upstream is converted to the Responses API via local 127.0.0.1:57321, which requires launching Codex from Alunixa X.",
  ...
  "维护 Alunixa X 自己的远程项目最近列表。": "Maintain Alunixa X's own recent list of remote projects.",
  "编辑": "Edit",
  ...
  "配置文件": "Config file",
  "配置模型": "Config model",
  "重启 Alunixa X": "Restart Alunixa X",
  "重新安装": "Reinstall",
  "重新生成": "Regenerate",
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "{0} 个": "{0}",
  "{0} 个 Alunixa X 可识别项目，默认策略：{1}": "{0} project(s) recognized by Alunixa X, default strategy: {1}",
  "{0} 个供应商": "{0} provider(s)",
  ...
  "{0} 个文件 / {1} 个图片副本 / {2}": "{0} file(s) / {1} image copy/copies / {2}",
  "{0} 个项目": "{0} project(s)",
  "{0} 副本": "{0} copy",
  "供应商 {0}": "Provider {0}",
  ...
  "检测到代理环境变量：{0}。请清理后重新启动 Alunixa X。":
    "Proxy environment variables detected: {0}. Remove them and restart Alunixa X.",
  ...
  "打开文件选择器失败：{0}": "Failed to open the file picker: {0}",
  ...
  "将外置 {0} 个已被后续压缩检查点覆盖的图片副本，预计释放 {1}。仍生效的最新检查点和含回滚记录的会话不会修改，且会创建可恢复备份。继续前请完全退出 Codex / ChatGPT。":
    "Externalize {0} image copy/copies superseded by later compaction checkpoints, reclaiming about {1}. The active latest checkpoint and rollback sessions remain unchanged, and a restorable backup will be created. Fully quit Codex / ChatGPT before continuing.",
  "第 {0} 页": "Page {0}",
  "第 {0} 页，每页最多 {1} 条，按更新时间倒序显示":
    "Page {0}, up to {1} sessions per page, newest first",
