...
export const EN_PLAIN: Record<string, string> = {
  ...
  "Wallpaper Engine 场景支持已移除，不会再启动引擎窗口。": "Wallpaper Engine scene support has been removed. No engine window will be launched.",
  "旧场景只显示预览图片，不运行场景；可上传新图片替换。": "This legacy scene displays only its preview image, not the scene. Import an image to replace it.",
